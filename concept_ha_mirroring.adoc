...
Un clúster de dos nodos con un mediador puede abarcar dos centros de datos. Para más información, consulte la sección link:reference_plan_best_practices.html#two-node-stretched-ha-metrocluster-sds-best-practices["Mejores prácticas para HA extendida de dos nodos (MetroCluster SDS)"] .
...
* ONTAP Select agregado reflejado * image:DDHA_03.jpg["Agregado reflejado ONTAP Select"]
...
* Flujo de trabajo de ONTAP Select * image:DDHA_04.jpg["Flujo de trabajo de ONTAP Select"]

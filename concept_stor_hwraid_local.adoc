...
NOTE: La sobrecarga de VMFS no es cero (VMware KB 1001618), y el intento de utilizar todo el espacio reportado como libre por un datastore ha dado lugar a errores falsos durante las operaciones de creación de clúster.

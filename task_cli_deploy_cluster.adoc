...
+
La utilidad de administración de implementación contiene una única versión de ONTAP Select. Si desea implementar clústeres con una versión anterior de ONTAP Select, primero debe... link:task_cli_deploy_image_add.html["añadir la imagen de ONTAP Select"] a su instancia de implementación.
...
.Después de terminar
Debe realizar una copia de seguridad de los datos de configuración de ONTAP Select Deploy.
